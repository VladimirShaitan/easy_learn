...
$config['consumerKey']              = 'zCl2moXzUNQr0j4fFvzyQ2P4j';
$config['consumerSecret']          = 'WOt0nref8MFxK2CUYQjYvC5dtmkUOX25oPUqUA0XWT1BjNQfkk';
$config['oauthCallback']          = ci_site_url().'Twitter';
