       <div class='panel panel-default col-lg-9'>
          <div class='panel-heading'>
            ...
            Управление заказами на выполнении
...
<!--                       <td class="actions">
            <?php // echo form_open('Adminorders/returntoopen', array('class'=>'jsform'));?>

                      <div class="form-group">
                      <div class="col-md-3">
                              <input type="hidden" name='order_status' value="Openproject" class="form-control" />
                              ...
                              <input type="hidden" name="from" value="assignedOrders">
                              <<input type='submit' class="" Value='К открытым проектам'>
