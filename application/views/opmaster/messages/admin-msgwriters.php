  ...
  <div class="widget-container fluid-height">
    <div class="widget-content padded">
      <div class="myUsersWrapper">
        <table class='table'>
          <h4>Сообщения авторам</h4>
          <p>(выберите автора чтобы написать ему в чат)</p>
          <tbody>
             <?php foreach ($writers as $my_user_single){ ?>
              <tr class="success">
                ...
                <td class="col-md-7 text-right"><a href="<?php echo site_url('in/Adminmsg/sup_chat/'.$my_user_single['writer_id'].'#ancBot'); ?>">Написать сообщение автору</a></td>
              </tr>
           <?php } ?>
          </tbody>
      </table>  
