     ...
     <ul class="nav nav-pills pull-left"> <h3> </h3></ul>
        <ul class="nav nav-pills pull-right">
           ...
           <?php if($this->session->userdata('admin_level') === 'super') { ?>
            <li><a href="#edit" data-toggle="tab">Редактировать и сохранить</a></li>
           <?php } ?>
        </ul>
    </div>
...
<?php echo form_open_multipart('adminmsg/mailto_writers'); ?>
...
<form class="form-horizontal">
   ...
   <div class="col-md-12">
                <textarea required class="ckeditor form-control" name="message"></textarea>
            </div>
            <!-- /controls -->
        </div>
        <!-- /form-group -->
...
<?php if($this->session->userdata('admin_level') === 'super') { ?>
  <div class="tab-pane fade" id="edit">
    <?php echo form_open('Siteconfigs/editmail_towriter');?>
    <div class="col-md-12">
     <textarea class="ckeditor form-control" name="msg_body_writer"><?php echo str_replace('\"','"',$msg_body_writer);?></textarea>
     <input type="hidden" class="form-control" name="msg_id" value = "<?php echo $msg_id;?>"/>
        ...
        <div class="col-md-11">
          <input class="form-control btn btn-danger"  type='submit' Value='Сохранить'>
        </div>
      </div>
</div>
              <?php echo form_close();?>
