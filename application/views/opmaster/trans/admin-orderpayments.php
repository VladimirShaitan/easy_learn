...
<?php foreach ($transactions as $transactions): ?>
                    <tr>
                      ...
                      <td>
                        #<?php echo $transactions['txn_id']; ?>
                      </td>                      
                      <td>
                        #<?php echo $transactions['user_id']; ?>
                      </td>
                      <td>
                       <?php echo $transactions['product_id']; ?> 
                      </td>

                      <td class="hidden-xs">
                        <?php echo $transactions['currency_code'].' '.$transactions['payment_gross']; ?>
                      </td>                      
                      <td class="hidden-xs">
                     <span class="label label-warning">  <?php echo $transactions['payer_email']; ?></span>
                      </td>
                      <td class="actions">
                        <div class="action-buttons">
                          <a class="table-actions" href="<?php echo ci_site_url('Adminfinance/view_trans/'.$transactions['txn_id']); ?>"><i class="fa fa-eye"></i></a>
