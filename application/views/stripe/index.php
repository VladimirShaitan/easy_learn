	...
	<h3>Stripe Payment</h3><br/>
		...
		<div class="col-sm-12">
		  ...
		  <div class="form-row form-group">
			...
			<input type="submit" class="submit btn btn-primary" value="Submit Payment $20">
		  </div>
	</form>
	</div>
	<?php $orderid=19990258;?>
	<script src="https://code.jquery.com/jquery-3.1.1.min.js"></script>
	<script type="text/javascript" src="https://js.stripe.com/v2/"></script>

	<script type="text/javascript">
	  Stripe.setPublishableKey('pk_test_W5bLpYs97PVw2nleiyVKpdje');
	  $(function() {
	 ...
	 function stripeResponseHandler(status, response) {
		 ...
		 if (response.error) {
			...
			$.ajax({
				url: '<?php echo site_url().'payment/process/'.$orderid; ?>',
